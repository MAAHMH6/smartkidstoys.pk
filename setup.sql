-- ============================================
-- STEP 1: Run this FIRST (create all tables)
...
('Colorful Building Blocks Set', 'Fun educational building set for kids ages 3+. 50 colorful pieces.', 1499, 1999, 'Building Blocks', 30, 4.7, 86, false, true, 'https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=400'),
('Remote Control Car', 'High-speed RC car with 2.4GHz remote. Rechargeable battery included.', 2799, 3299, 'Vehicles', 20, 4.6, 64, true, false, 'https://images.unsplash.com/photo-1594736797933-d0501ba2fe65?w=400'),
...
('Rainbow Stacker', 'Classic wooden rainbow stacker toy. Develops motor skills and color recognition.', 1299, 1699, 'Educational', 35, 4.9, 77, false, true, 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=400'),
...
('Alphabet Learning Board', 'Interactive alphabet board with sounds. Great for toddlers learning letters.', 1150, 1450, 'Educational', 40, 4.6, 43, true, false, 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=400'),
...
('Baby Rattle Set', 'Colorful BPA-free baby rattle set. 4 pieces. Suitable for 0+ months.', 650, null, 'Baby Toys', 80, 4.8, 112, false, false, 'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=400'),
('Magnetic Drawing Board', 'Mess-free magnetic drawing board with easy erase. Great for travel.', 1350, 1750, 'Educational', 28, 4.5, 67, false, true, 'https://images.unsplash.com/photo-1596464716127-f2a82984de30?w=400'),
('Plush Bunny Rabbit', 'Adorable soft plush bunny rabbit. Machine washable. 35cm tall.', 1200, 1599, 'Soft Toys', 55, 4.7, 89, true, false, 'https://images.unsplash.com/photo-1555448248-2571daf6344b?w=400'),
...
('Toy Kitchen Set', 'Complete toy kitchen playset with accessories. 32 pieces included.', 3299, 3999, 'Educational', 15, 4.8, 56, true, true, 'https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?w=400'),
...
('Dinosaur Action Figures', 'Set of 6 realistic dinosaur figures. Educational and fun for all ages.', 1450, null, 'Educational', 38, 4.5, 73, false, false, 'https://images.unsplash.com/photo-1548197047-3dcdb0fef0a4?w=400'),
('Stuffed Elephant', 'Large grey stuffed elephant with smiley face. 40cm tall. Super soft.', 1850, 2299, 'Soft Toys', 20, 4.9, 45, false, true, 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=400'),
...
('Musical Toy Piano', 'Mini 8-key piano with songs and recording feature. USB chargeable.', 1699, 2199, 'Educational', 30, 4.6, 82, true, true, 'https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=400'),
